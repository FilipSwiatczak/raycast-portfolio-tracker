...
const SPLIT_PALETTES: Record<"light" | "dark", SplitPalette> = {
  dark: {
    ...
    accessible: { hex: "#30D158", opacity: 0.8 },
    locked: { hex: "#FF9F0A", opacity: 0.7 },
    unlocked: { hex: "#30D158", opacity: 0.45 },
    targetLine: solid("#FF9F0A"),
    fireHighlight: { hex: "#34C759", opacity: 0.12 },
    fireAccent: solid("#34C759"),
    sippLine: { hex: "#FF9F0A", opacity: 0.6 },
    text: { hex: "#FFFFFF", opacity: 0.82 },
    mutedText: { hex: "#FFFFFF", opacity: 0.45 },
    legendText: { hex: "#FFFFFF", opacity: 0.6 },
    accessibleBarLabel: { hex: "#000000", opacity: 0.65 },
    lockedBarLabel: { hex: "#000000", opacity: 0.65 },
  },
  light: {
    background: solid("#FFFFFF"),
    barTrack: { hex: "#000000", opacity: 0.06 },
    accessible: { hex: "#34C759", opacity: 0.7 },
    locked: { hex: "#FF9500", opacity: 0.6 },
    unlocked: { hex: "#34C759", opacity: 0.4 },
    targetLine: solid("#FF9500"),
    fireHighlight: { hex: "#34C759", opacity: 0.1 },
    fireAccent: solid("#34C759"),
    sippLine: { hex: "#FF9500", opacity: 0.5 },
