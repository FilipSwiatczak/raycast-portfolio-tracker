...
const DEBT_PALETTES: Record<"light" | "dark", DebtPalette> = {
  dark: {
    ...
    principal: solid("#FF453A"),
    interest: solid("#FF9F0A"),
    debtFreeHighlight: { hex: "#34C759", opacity: 0.12 },
    debtFreeAccent: solid("#34C759"),
    text: { hex: "#FFFFFF", opacity: 0.82 },
    mutedText: { hex: "#FFFFFF", opacity: 0.45 },
    legendText: { hex: "#FFFFFF", opacity: 0.6 },
    principalBarLabel: { hex: "#FFFFFF", opacity: 0.9 },
    interestBarLabel: { hex: "#000000", opacity: 0.7 },
  },
  light: {
    background: solid("#FFFFFF"),
    barTrack: { hex: "#000000", opacity: 0.06 },
    principal: solid("#FF3B30"),
    interest: solid("#FF9500"),
    debtFreeHighlight: { hex: "#34C759", opacity: 0.1 },
    debtFreeAccent: solid("#34C759"),
    text: { hex: "#000000", opacity: 0.82 },
    mutedText: { hex: "#000000", opacity: 0.45 },
    legendText: { hex: "#000000", opacity: 0.6 },
    principalBarLabel: { hex: "#FFFFFF", opacity: 0.9 },
    interestBarLabel: { hex: "#FFFFFF", opacity: 0.9 },
  },
};
